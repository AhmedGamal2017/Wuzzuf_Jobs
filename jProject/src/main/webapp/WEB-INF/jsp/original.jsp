					...
					<ul class="navbar-nav mx-auto h-100">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-itemactive" href="/original">Original Data</a>
			...
			<div class="row tm-content-row">
				...
				<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-block-col">
					<div class="tm-bg-primary-dark tm-block tm-block-scroll">
						<h2 class="tm-block-title">Structure</h2>
						<table class="table">
							<thead>
								<tr>
									<c:forEach items="${StructureHeads}" var="head">
										<th scope="col">${ head}</th>
									</c:forEach>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${DataStructure}" var="row">
									<tr>
				...
				<div class="col-12 tm-block-col">
					<div class="tm-bg-primary-dark tm-block tm-block-scroll">
						<h2 class="tm-block-title">Original Data</h2>
				...
				<div class="col-12 tm-block-col">
					<div
						...
						<h2 class="tm-block-title">Summary</h2>
						<table class="table">
							<thead>
								<tr>
									<c:forEach items="${SummaryHeads}" var="head">
										<th scope="col">${ head}</th>
									</c:forEach>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${DataSummary}" var="row">
									<tr>
										<c:forEach items="${row}" var="cell">
											<td>${cell}</td>
										</c:forEach>
