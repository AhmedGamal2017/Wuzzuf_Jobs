						...
						<ul class="navbar-nav mx-auto h-100">
							...
							<li class="nav-item dropdown">
								...
								>
									...
									<span> Statistics <i class="fas fa-angle-down"></i> </span>
								</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="/trendcomp"
										>Most Demanding Companies</a
									>
									<a class="dropdown-item active" href="/trendjob"
										>Popular Jobs</a
									>
				...
				<div class="row tm-content-row">
					...
					<div class="col-12 tm-block-col">
						...
						<div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
							<h2 class="tm-block-title">Most Popular Job Titles Chart</h2>
							<canvas id="barChart" width="800" height="20000"></canvas>
						</div>
			...
			$(document).ready(function () {
				$.ajax({
					...
					success: function (data) {
						...
						drawBarChart(labels, values, coloR,"Count [Title]", "Title");
					},
					error: function (data) {
						console.log(data);
					},
